...
# Create an image which will be used to display the environment
    ...
    for training_iteration in range(200):
        ...
        for step_num in range(20):
            ...
            network_prediction = optimise_model()
    ...
    transition1 = (np.array([0.15,0.15],dtype = np.float32),3,0,np.array([0.15,0.25],dtype = np.float32))
    transition2 = (np.array([0.15,0.25],dtype = np.float32),3,0,np.array([0.15,0.35],dtype = np.float32))
    transition3 = (np.array([0.15,0.35],dtype = np.float32),0,0,np.array([0.25,0.35],dtype = np.float32))
    transition4 = (np.array([0.25,0.35],dtype = np.float32),3,0,np.array([0.25,0.45],dtype = np.float32))
    transition5 = (np.array([0.25,0.45],dtype = np.float32),0,0,np.array([0.25,0.55],dtype = np.float32))

    transitions1 = []
    transitions1.append(transition1)
    transitions1.append(transition2)
    transitions1.append(transition3)
    transitions1.append(transition4)
    transitions1.append(transition5)
    ...
    cv2.circle(image,(int(transition5[3][0]*magnification),int((1 - transition5[3][1])*magnification)), 15, (0,255,0), -1)
    R = [0,0,255]
    G = [0,255,0]
    ...
    cv2.imwrite('Optimal_action_graph2.png',image)
# This line is necessary to give time for the image to be rendered on the screen
    cv2.waitKey(0)
