...
% This is the code that was promised in the 'complex_wahwah_s1505528'
% script. It is the same as the wah wah but with a continuously increasing
% oscillation rate of the wah wah. It works pretty well. I guess we could
% choose any function that doesn't go negative and doesn't go too large a
% number. I just chose a linear changing oscillation rate. 
...
fwah = 3*2*n/length(y); % Continuously changing wah wah oscillation rate.
