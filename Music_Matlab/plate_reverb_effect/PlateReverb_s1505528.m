...
% This script adds plate reverb to an audio file and also creates an
% impulse response for two different plates. The materials I have chosen in
% thi script are steel and titanium. 
...
% From the while and if loops we can find the values for Q, Qx and Qy. 
...
%audiowrite('PlateReverb_s1505528_default_dryout.wav', y, Fs);
%audiowrite('PlateReverb_s1505528_extra_dryout.wav', y, Fs);
...
%audiowrite('PlateReverb_s1505528_default_IR.wav',ir,Fs);
%audiowrite('PlateReverb_s1505528_extra_IR.wav', ir, Fs);
