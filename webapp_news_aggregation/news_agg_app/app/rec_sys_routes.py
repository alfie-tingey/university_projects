...
from app.models import Post, News_agg, News, Topics, Topics_database, Article, Comment, User
from flask_login import current_user, login_user

def news_panda():
    dir_path = os.path.dirname(os.path.realpath(__file__))
    news_history_path = "/Users/alfredtingey/news-aggregation-system/news_agg_app/news_history.json" #dir_path + "/../working_code/news_history.json"
...
class User_recommend():
    ...
    def __init__(self, user_key_words, date, w2v_model):
        ...
        self.user_history_dict = self.get_user_history()
        # print("TFIDF_dict")
        ...
        if w2v_model == "GoogleNews":
            ...
            for category in self.categories:
                ...
                self.key_words_NN_dict[category] = {}
                if len(self.TFIDF_dict[category].index > 0) and len(self.C_count_dict[category].index > 0):
                    model = Word2Vec.load(f"/Users/alfredtingey/news-aggregation-system/news_agg_app/word2vec_{method}_{category}.model")
